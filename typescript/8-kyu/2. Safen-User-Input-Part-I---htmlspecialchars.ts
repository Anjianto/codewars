 ...
 * so visitors can send emails or leave a comment on your website with ease.
 * However, with ease comes danger. Every now and then, a hacker visits your
 * website and attempts to compromise it through the use of XSS (Cross Site Scripting).
 ...
 * Mission
 *
 * Your mission is to implement a function htmlspecialchars() that converts the following
 ...
 * Extension
 *
 * If you are an experienced Javascript programmer, try shortening your code as much as possible
 * and optimise it to minimise run time.
...
export function htmlspecialchars2(formData: string): string {
